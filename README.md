...
The lowest level programming languages created by humans are assembly languages, which are different depending on hardware. The next level up from these would be C language. Today these languages are mainly used to create operating systems and games. The list of programing languages that are commonly used is long and always changing, but you can always find out about more languages by googling them.
